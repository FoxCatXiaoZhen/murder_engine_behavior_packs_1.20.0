#执行弹道计算和前进
#s execute as @e[type=function:flying_blade] at @s run function call_function/flying_blade/measuring_angle
#当碰撞墙壁就消除自己
...
#太久没判断到实体或墙壁，就清除
#s scoreboard players add @e[type=function:flying_blade] tick 1
