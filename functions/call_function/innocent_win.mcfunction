...
execute as @a[scores={version=1}] run tellraw @a { "rawtext": [{ "text": "\n§f•§a平民§f[§a赢家§f]:" },{ "selector": "@a[scores={version=1}]" }] }
execute as @a[scores={version=2}] run tellraw @a { "rawtext": [{ "text": "\n§f•§b侦探§f[§a赢家§f]:" },{ "selector": "@a[scores={version=2}]" }] }
execute as @a[scores={version=3}] run tellraw @a { "rawtext": [{ "text": "\n§f•§c杀手§f:" },{ "selector": "@a[scores={version=3}]" }] }
